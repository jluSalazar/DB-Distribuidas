...
namespace WinAppBiblioteca.Forms
{
    public partial class ClienteUIOActualizar : Form
    {
        ...
        private void ListarDGV()
        {
            ...
            string consulta = "SELECT * FROM CLIENTE_UIO";
            conn.Open();
        ...
        private void ClienteUIOActualizar_Load(object sender, EventArgs e)
        {
            this.ListarDGV();
        }
        ...
        private void Actualizar(string id, string idsucursal, string nombre, string apellido, string ciudad, string provincia, string telefono)
        {
            ...
            string updateQuery = "UPDATE CLIENTE_UIO SET IDSUCURSAL = :idsucursal, NOMBRE = :nombre, APELLIDO = :apellido, CIUDAD = :ciudad, PROVINCIA = :provincia, TELEFONO = :telefono WHERE IDCLIENTE = :idCliente";
